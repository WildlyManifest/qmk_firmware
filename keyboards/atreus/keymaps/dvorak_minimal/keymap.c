...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [PUNM] = LAYOUT(
        KC_MINS, KC_SLSH, KC_BSLS, KC_LBRC, KC_RBRC,
        ...
        KC_GRV, KC_P1, KC_P2, KC_P3, KC_PEQL,

        KC_TRNS, KC_TRNS, LALT_T(KC_ESC), KC_TRNS, KC_TAB, KC_TRNS,
    ...
    [FNNV] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_LALT, KC_VOLD, KC_VOLU, KC_TRNS,
        KC_TRNS, KC_EJCT, KC_TRNS, RALT_T(KC_MSTP), KC_TRNS, KC_RSFT
    )
};
